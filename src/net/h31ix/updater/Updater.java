        ...
        try 
        {
            ...
            while (eventReader.hasNext()) 
            {
                ...
                if (event.isStartElement()) 
                {
                    ...
                    {
                    	description = "";
                    	while(!event.isEndElement() || (event.isEndElement() && !event.asEndElement().getName().getLocalPart().equals(DESCRIPTION))){
                            event = eventReader.nextEvent();
                            if(event.isCharacters()) description += event.asCharacters().getData();
                    	}
                        continue;
                    }
                }
